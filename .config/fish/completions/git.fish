...
#sadly, "mergetool" and "merge" wind up being so close...
#complete -f -c git -n '__fish_git_needs_command' -a mergetool -d 'Fix merge conflicts like a human being'
...
complete -f -c git -n '__fish_git_using_command jira-branch' -a '(__cached_jira_issues)' -d 'Jira Issue'
